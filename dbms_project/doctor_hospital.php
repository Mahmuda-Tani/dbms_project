...
<div class="container">
 ...
 <br>
 <br>
 <br> <div class="heading"><h2>All Covid Patients  Detail  Who are  admitted into Hospital_Id-<?php echo $id?></h2></div><br>
...
<div class="extra_div">
   ...
   <br>
         <table border="1" style="width : 40%;" class="covid_ward">
                   <tr>
                       <th>Pat_id</th>
                       <th>Ward_id</th>
                       <th>Status</th>
    ...
    <!-- <br> <div class="heading"><h2>Covid-19 overview of Your Hospital</h2></div><br>
